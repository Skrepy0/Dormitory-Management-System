...
std::string StayLog::getHash(){
    return simpleHashString(getCurrentTimestamp());
}
...
StayLog::StayLog(std::string type, Time time, std::string id, std::string name,nlohmann::json dormitoryData) : type(type), time(time)
                                                                                    , id(id), name(name),
...
Time StayLog::getTime() {
    return this->time;
}

std::string StayLog::getId() {
    return this->id;
}

std::string StayLog::getName() {
    return this->name;
}

nlohmann::json StayLog::getDormitoryData() {
...
void StayLog::setData(nlohmann::json data) {
    this->data = data;
}

void StayLog::setTime(Time time) {
    this->time = time;
}

void StayLog::setId(std::string id) {
    this->id = id;
}

void StayLog::setName(std::string name) {
    this->name = name;
}

void StayLog::setDormitoryData(nlohmann::json dormitoryData) {
