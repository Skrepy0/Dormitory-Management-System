...
std::string Maintenance::getSponsor()
{
	return sponsor;
}

std::string Maintenance::getDescription()
{
	return description;
}

std::string Maintenance::getRepairer()
{
	return repairer;
}

std::string Maintenance::getValuation()
{
	return valuation;
}

bool Maintenance::getState()
{
	return state;
}

Time Maintenance::getReportTime()
{
	return reportTime;
}

Time Maintenance::getRepairTime()
{
	return repairTime;
}

std::string Maintenance::getId()
{
	return id;
}

void Maintenance::setMaintenanceData(nlohmann::json data)
{
	this->data = data;
}

void Maintenance::setSponsor(std::string sponsor)
{
	this->sponsor = sponsor;
}

void Maintenance::setDescription(std::string description)
{
	this->description = description;
}

void Maintenance::setRepairer(std::string repairer)
{
	this->repairer = repairer;
}

void Maintenance::setValuation(std::string valuation)
{
	this->valuation = valuation;
}

void Maintenance::setState(bool state)
{
	this->state = state;
}

void Maintenance::setReportTime(Time time)
{
	this->repairTime = time;
}

void Maintenance::setRepairTime(Time time)
{
	this->repairTime = time;
}
